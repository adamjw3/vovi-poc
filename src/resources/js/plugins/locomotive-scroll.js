                ...
                value: function checkScroll() {
                    ...
                    if (forced || this.isScrolling || this.isDraggingScrollbar) {
                        ...
                        if (
                            ...
                            timeSinceStart > 100 &&
                            ((distance < 0.5 && this.instance.delta[this.directionAxis] != 0) || (distance < 0.5 && this.instance.delta[this.directionAxis] == 0))
                        ) {
                            this.stopScrolling();
                        }
                        ...
                        Object.entries(this.sections).forEach(function (_ref) {
                            ...
                            if (
                                section.persistent ||
                                (_this4.instance.scroll[_this4.directionAxis] > section.offset[_this4.directionAxis] &&
                                    _this4.instance.scroll[_this4.directionAxis] < section.limit[_this4.directionAxis])
                            ) {
